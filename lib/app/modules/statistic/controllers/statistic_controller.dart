...
class StatisticController extends GetxController {
  ...
  late List<SalesInvoice> currentAndPrevFilteredSalesInvoices =
      <SalesInvoice>[].obs;
  late List<OperatingCost> currentAndPrevFilteredOperatingCosts =
      <OperatingCost>[].obs;
  ...
  Future<List<Chart>> getChartData(
    ...
    void dayValueLooping(int i) {
      ...
      for (var inv in invoicesGroup) {
        ...
        double costPrice = inv.purchaseList.value.getTotalCost();
      ...
      // debugPrint(totalOperatingCost.toString());
