...
class CalculatePrice extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Obx(
        () {
          var editPurchaseList = controller.editPurchaseList.value;
          bool showTotalPurchase =
              editPurchaseList.getSubtotal(invoice.priceType) !=
                  editPurchaseList.getTotal(invoice.priceType);
            ...
            children: [
              PropertiesRowWidget(
                ...
                value: controller.currency
                    .format(editPurchaseList.getSubtotal(invoice.priceType)),
              ...
              if (showDiscount)
                PropertiesRowWidget(
                  title: 'Total Diskon',
                  value:
                      '-${controller.currency.format(editPurchaseList.totalIndividualDiscount)}',
              ...
              if (showTotalPurchase)
                PropertiesRowWidget(
                  title: 'TOTAL BELANJA',
                  value: controller.currency
                      .format(editPurchaseList.getTotal(invoice.priceType)),
                  primary: true,
                ),
                  ...
                  Expanded(
                    child: SizedBox(
                      child: TextField(
                        ...
                        controller: controller.payTextC, //! PayValue
              ...
              if (showChange)
                PropertiesRowWidget(
                  title: controller.totalChange.value > -1
                      ...
                      : 'Kurang Bayar',
                  value:
                      controller.currency.format(controller.totalChange.value),
                  color: Colors.grey,
                ),
              const SizedBox(height: 20),
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () async {
                        if (editPurchaseList.getTotal(invoice.priceType) > 0) {
