    ...
    return Obx(
      () => GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Card(
            color: !invoiceList.isPaid! ? Colors.red[100] : Colors.green[100],
            child: InkWell(
              splashColor: !invoiceList.isPaid!
                  ? Colors.red[200]!.withOpacity(0.2)
                  : Colors.green[200]!.withOpacity(0.3),
              highlightColor: !invoiceList.isPaid!
                  ? Colors.red[200]!.withOpacity(0.2)
                  : Colors.green[200]!.withOpacity(0.3),
              onTap: () async {
                      ...
                      title: Row(
                        children: [
                          ...
                          SizedBox(
                            width: 100,
                            child: Text(
                              'Rp.${controller.currency.format(invoiceList.bill)}',
