                                ...
                                children: [
                                  ...
                                  ListTile(
                                    title: Column(
                                      ...
                                      children: [
                                        Text(
                                            'Rp.${controller.currency.format(invoice.returnPrice)}'),
                                        Row(
                                          children: [
                                            const Expanded(
                                                flex: 5, child: Text('')),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Expanded(
                                              flex: 4,
                                              child: Text(
                                                'Rp.${controller.currency.format(invoice.returnPrice! - invoice.returnFee!)}',
                                                textAlign: TextAlign.end,
                                                style: Theme.of(Get.context!)
                                                    .textTheme
                                                    .bodyLarge!
                            ...
                            title: Row(
                              children: [
                                ...
                                Expanded(
                                    flex: 2,
                                    child: Text(
                                        'Rp.${controller.currency.format((invoice.bill))}',
                                        style: Theme.of(Get.context!)
                                            .textTheme
                                            .titleLarge,
                                        textAlign: TextAlign.end)),
                              ...
                              title: Row(
                                children: [
                                  ...
                                  Expanded(
                                      flex: 2,
                                      child: Text(
                                          'Rp.${controller.currency.format((invoice.bill! - ((invoice.returnPrice ?? 0) - (invoice.returnFee ?? 0))))}',
                                          style: Theme.of(Get.context!)
                                              .textTheme
                                              .titleLarge,
                                          textAlign: TextAlign.end)),
                              ...
                              title: Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 2,
                                    child: Text(
                                        'Rp.${controller.currency.format(invoice.pay!)}',
                                        style: Theme.of(Get.context!)
                                            .textTheme
                                            .titleSmall,
                                        textAlign: TextAlign.end),
                              ...
                              title: Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 2,
                                    child: Text(
                                      'Rp.${controller.currency.format((invoice.change! * -1) - ((invoice.returnPrice ?? 0) - (invoice.returnFee ?? 0)))}',
                                      style: Theme.of(Get.context!)
                                          .textTheme
                                          .titleLarge!
                                          .copyWith(
                      ...
                      if (!invoice.isPaid!)
                        ElevatedButton(
                          onPressed: () {
                            ...
                            controller.totalChange.value = invoice.change!;
                              ...
                              content: Obx(
                                () => Column(
                                  children: [
                                    ...
                                    Text(
                                      'Rp.${controller.currency.format((invoice.change! * -1) - controller.totalReturnFinal.value)}',
