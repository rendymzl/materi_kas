...
class SalesPaymentCard extends StatelessWidget {
  const SalesPaymentCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    late SalesPaymentController controller = Get.put(SalesPaymentController());
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Obx(
                          () => Text(
                            'Rp${controller.currency.format(invoice.totalCost)}',
                            style: TextStyle(
                                fontSize: 32,
                                fontWeight: FontWeight.bold,
